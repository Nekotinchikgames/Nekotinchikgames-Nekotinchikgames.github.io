...
<head>
   ...
   <title><?php echo $aboutName; ?> - <?php echo $siteName; ?></title>
</head>
<body>
...
<div class="about-section">
    <h2>Про нас</h2>
    <p>Ми — це маленька майстерня, де кожен ремінь і гаманець створюються з любов’ю та увагою до деталей. Кожен продукт — це результат ретельної роботи та прагнення до досконалості.</p>
    <p>Ми використовуємо тільки високоякісну натуральну шкіру та слідкуємо за кожним етапом виробництва, щоб надати нашим клієнтам тільки найкраще.</p>
    <div class="about-quote">
        <p>“Шкіра — це не просто матеріал, це мистецтво.”</p>
    </div>
</div>
